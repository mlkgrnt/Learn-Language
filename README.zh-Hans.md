...
| Skill | 命令 | 功能 |
|-------|------|------|
| **教材重构机** | `/process-material` | 导入教材（PDF、Word、Excel 等），转换为结构化数据 |
| **课程学习机** | `/learn-language` | 交互式上课，含练习、进度追踪、自适应节奏 |
